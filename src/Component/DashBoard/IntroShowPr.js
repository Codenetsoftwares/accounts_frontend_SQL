...
const IntroShowPr = () => {
  ...
  const handelDate = () => {
    ...
    const filteredDocuments = Transaction.filter((data) => {
    ...
    <div className="container-fuid">
      <div className="container mt-5">
        ...
        <div className="d-flex mt-2 pl-5 justify-content-center">
          ...
          <div className="d-flex pt-3 justify-content-center mb-3">
          ...
          <div className="d-flex pt-3 justify-content-center">
            ...
            {toggle ? (
              <div className="mx-2">
                <CSVLink data={Transaction} className="btn btn-success">
                  Download Data
                </CSVLink>
              </div>
            ) : (
