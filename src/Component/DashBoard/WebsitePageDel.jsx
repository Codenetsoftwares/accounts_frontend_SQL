...
const WebsitePageDel = () => {
  ...
  // useEffect(() => {
  //   if (auth.user) {
  //     EditServices.ViewWebsiteDelAlert(auth.user).then((res) => setAlert(res.data));
  //   }
  // }, [auth]);
  console.log(alert);
  ...
  const handleApprove = (e, _id) => {
    ...
    EditServices.IsWebsiteDelApprove(_id, data, auth.user)
      .then((response) => {
  ...
  return <>
    <h1 className="d-flex justify-content-center">Delete Request</h1>
